...
Las instrucciones:
crear_escuela: Inicializa la cuenta con nombre y dueño.
agregar_alumno: Añade un alumno nuevo validando que no pases el límite máximo.
eliminar_alumno: Remueve alumno por matrícula buscando posición en el vector.
editar_alumno: Modifica los campos que recibas, con Option para actualizar sólo los necesarios.
